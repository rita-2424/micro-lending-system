...
const LenderDashboardPage = () => {
    ...
    console.log("User ID from localStorage:", userId);
      ...
      const fetchLoanRequests = async () => {
        try {
            ...
            const lender = "0x20301285102F899Ec34B48B8e5F55eE4785382B8";
            const response = await axios.get(`http://localhost:3000/api/loans/fetchLoanRequests/${lender}`);
  ...
  return (
    <div style={styles.container}>
      ...
      <section style={styles.section}>
        ...
        <h4 style={{ ...styles.loanText, textAlign: 'center' }}>role: lender</h4>
  ...
  <Link to="/LenderPage" style={styles.link}>
    Lend a Peer
  </Link>
